...
| 10 | CEPA silver rate FY2025-26 | Not located | Not found in the documents read | The replay shows PLACEHOLDER for that year until added |
| 11 | FY2026-27 CEPA gold quota allocation | None found up to 25 Sep 2026 | May not be issued yet | From 1 Oct the flag reads NOT STATED; update when DGFT publishes |
| 12 | "$719M" (Feb 2024) and "~$157M" (Aug-Dec 2024) | Not found | No publication located | TradeStat monthly query, then add as facts with the query details |
| 13 | MCX holiday calendar and listing cycles | Not loaded / from general knowledge | mcxindia.com blocks automated access | Rule-computed expiries and unlisted months are PROBABLE; add listed contracts as MCX launches them |
| 14 | GST base and 3% default rate | PROBABLE | Needs a CA review | Send docs/METHODOLOGY.md section 4 to a CA |
| 15 | Normal-route executability | STANDARD ROUTE, PROBABLE | No executability document cited for who may import | Add the DGFT import-policy condition for gold and silver bars if wanted |
| 16 | Kite Connect | Not connected (by design) | Terms forbid public display; you chose "later" | Private owner view only, Rs 500 a month, when you want it |
