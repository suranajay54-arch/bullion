...
1. [ ] **Publish** (20 minutes): README, "Five steps". Note the address shown under Settings > Pages.
...
4. [ ] **Look at the automatic check:** Actions > "Check the live site" > latest run > Artifacts > live-site-check (screenshots and report).
